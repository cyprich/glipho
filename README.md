...
| [](./examples/sample.jpg) | [](./examples/min.jpg)             | Min                  | `0` to `255`    | Applies minimal threshold to all pixels. If the pixel is darker than threshold, it will be changed to the threshold value, making it brighter |
| [](./examples/sample.jpg) | [](./examples/max.jpg)             | Max                  | `0` to `255`    | Applies maximal threshold to all pixels. If the pixel is brighter than threshold, it will be changed to the threshold value, making it darker |
